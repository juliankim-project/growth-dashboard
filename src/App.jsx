...
export default function App() {
  ...
  const { session, loading, accessError, user, signInWithMagicLink, signInWithSSO, signOut } = useAuth()
  ...
  if (!session) return (
    <Login dark={dark} onSignInWithMagicLink={signInWithMagicLink} onSignInWithSSO={signInWithSSO} accessError={accessError} />
  )
